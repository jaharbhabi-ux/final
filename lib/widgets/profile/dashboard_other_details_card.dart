      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.description_rounded, size: 16, color: AppTheme.warningColor),
          ...
          if (isEmpty)
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.description_outlined, size: 18, color: AppTheme.textHint),
                  const SizedBox(width: 8),
                  Text(
            ...
            Padding(
              ...
              child: SelectableText(
                raw,
                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: AppTheme.textPrimary, height: 1.5),
              ),
            ),
        ],
      ),
