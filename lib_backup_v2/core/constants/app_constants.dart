// एप्लिकेशन कॉन्स्टैंट्स - App Constants
// सभी CSV URL, गूगल शीट ID और कॉन्फ़िगरेशन यहाँ रखें
...
static const String gsheetsBaseUrl = 'https://docs.google.com/spreadsheets/d';
  ...
  /// ⚠️ SECURITY TOKEN — Google Apps Script har write request pe
  /// is token ko validate karta hai. Bina token ke koi write nahi
  /// hoga. Token GAS Code.gs ke `API_TOKEN` se match hona chahiye.
  ...
  /// मुख्य डेटा स्रोत - Main ALL Employees sheet
  static const String sheetAll = 'ALL';
  static const String sheetAllGid = '710993359';

  /// अतिरिक्त कर्मचारी - Extra Employees
  ...
  /// सम्बन्ध - Sambadh (Relations / Family / Nominee details)
  static const String sheetSambadh = 'Sambadh';
  static const String sheetSambadhGid = '0';

  /// सभी शीट्स की लिस्ट - All sheets list for parallel loading.
