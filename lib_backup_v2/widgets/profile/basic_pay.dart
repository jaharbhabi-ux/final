...
class BasicPay {
  ...
  factory BasicPay.fromMap(Map<String, dynamic> map) {
    ...
    return BasicPay(
      ...
      transportAllowance:
          _val(map, ['TA', 'यात्रा भत्ता', 'Transport Allowance']),
  ...
  List<MapEntry<String, String>> get allFields {
    final typed = <MapEntry<String, String>>[
      if (effectiveDate.isNotEmpty) MapEntry('प्रभावी तिथि', effectiveDate),
      ...
      if (incrementMonth.isNotEmpty) MapEntry('वृद्धि माह', incrementMonth),
    ];
